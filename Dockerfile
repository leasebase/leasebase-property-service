...
WORKDIR /app/service
COPY leasebase-property-service/package.json leasebase-property-service/package-lock.json* ./
RUN npm ci
COPY leasebase-property-service/tsconfig.json ./
COPY leasebase-property-service/src ./src
RUN npm run build
